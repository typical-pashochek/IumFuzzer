    ...
    PMIDL_STUB_MESSAGE pStubMsg )
{
    ...
    pParamStruct->_RetVal = IumSystemCall(pParamStruct->IDL_handle,pParamStruct->pData);
...
static const SERVER_ROUTINE IumFuzzer_ServerRoutineTable[] = 
    ...
    (SERVER_ROUTINE)IumSystemCall
    };

static const STUB_THUNK IumFuzzer_StubThunkTable[] = 
    {
    0,
    0,
    0,
