...
extern const MIDL_SERVER_INFO IumFuzzer_ServerInfo;

extern const RPC_DISPATCH_TABLE IumFuzzer_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE IumFuzzer___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x12345678,0x1234,0x1234,{0x12,0x34,0x12,0x34,0x56,0x78,0x90,0xAB}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&IumFuzzer_v1_0_DispatchTable,
    0,
    0,
    0,
    &IumFuzzer_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE IumFuzzer_v1_0_s_ifspec = (RPC_IF_HANDLE)& IumFuzzer___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION IumFuzzer_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE IumFuzzer_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)IumFuzzer_table
    };
...
static const MIDL_STUB_DESC IumFuzzer_StubDesc = 
    {
    (void *)& IumFuzzer___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& IumFuzzer_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION IumFuzzer_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE IumFuzzer_NDR64__v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)IumFuzzer_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO IumFuzzer_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&IumFuzzer_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE IumFuzzer_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)SendData,
    (SERVER_ROUTINE)ReceiveData,
    (SERVER_ROUTINE)Terminate,
    (SERVER_ROUTINE)GetIdentityKey
    };

static const MIDL_SERVER_INFO IumFuzzer_ServerInfo = 
    {
    &IumFuzzer_StubDesc,
    IumFuzzer_ServerRoutineTable,
    IumFuzzer__MIDL_ProcFormatString.Format,
    (unsigned short *) IumFuzzer_FormatStringOffsetTable,
    0,
